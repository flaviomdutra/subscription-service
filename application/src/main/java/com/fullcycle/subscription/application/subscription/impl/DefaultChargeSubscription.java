...
public class DefaultChargeSubscription extends ChargeSubscription {
    ...
    public Output execute(final Input in) {
        if (in == null) {
            throw new IllegalArgumentException("Input of DefaultChargeSubscription should not be null");
        }
    ...
    record StdOutput(SubscriptionId subscriptionId, String subscriptionStatus, LocalDate subscriptionDueDate,
                     Transaction paymentTransaction) implements ChargeSubscription.Output {
    }
}
