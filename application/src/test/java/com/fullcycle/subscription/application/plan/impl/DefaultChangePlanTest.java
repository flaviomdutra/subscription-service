...
class DefaultChangePlanTest extends UnitTest {
    ...
    public void givenValidInput_whenCallsExecute_shouldChangePlan() {
        ...
        var expectedDescription = "Master planm";
        ...
        // when
        final var actualOutput = this.target.execute(new ChangePlanTestInput(expectedPlanId.value(), expectedName, expectedDescription, expectedPrice, expectedCurrency, expectedActive));
