...
public class SubscriptionRestController implements SubscriptionRestApi {
    ...
    public SubscriptionRestController(final CreateSubscription createSubscription, final CancelSubscription cancelSubscription, final ChargeSubscription chargeSubscription) {
    ...
    public ResponseEntity<ChargeSubscriptionResponse> chargeActiveSubscription(final ChargeSubscriptionRequest req, final CodeflixUser principal) {
        record ChargeSubscriptionInput(String accountId, String paymentType,
                                       String creditCardToken) implements ChargeSubscription.Input {
        }
