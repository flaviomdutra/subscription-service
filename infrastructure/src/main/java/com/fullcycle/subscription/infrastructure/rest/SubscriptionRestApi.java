...
public interface SubscriptionRestApi {
    ...
    ResponseEntity<CreateSubscriptionResponse> createSubscription(@RequestBody @Valid CreateSubscriptionRequest req, @AuthenticationPrincipal final CodeflixUser principal);
    ...
    ResponseEntity<ChargeSubscriptionResponse> chargeActiveSubscription(@RequestBody @Valid ChargeSubscriptionRequest req, @AuthenticationPrincipal final CodeflixUser principal);
